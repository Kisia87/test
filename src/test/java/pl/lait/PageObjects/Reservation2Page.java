...
public class Reservation2Page {
	...
	private static final String DelCountry = null;
	...
	static String select_passMeal_name = "pass.0smeal";
	...
	static String input_cc_first_name = "cc_first_name";
	static String input_cc_mid_name = "cc_mid_name ";
	static String input_cc_last_name = "cc_last_name ";
	static String input_billAddress1_name = "billAddress1_name";
	...
	static String input_billCity = "billCity";
	static String select_del_country = "selectDelCountry";
	...
	public WebElement chcecboxTicketLessTravel(WebDriver driver){
	...
	public WebElement inputBillCity(WebDriver driver){
		return driver.findElement(By.name(input_billCity));
	}
	public Select selectDelCountry(WebDriver driver){
		return new Select(driver.findElement(By.name(select_del_country)));
	}
